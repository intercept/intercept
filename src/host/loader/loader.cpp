...
namespace intercept {
    ...
    static std::pair<std::future<uintptr_t>, std::future<uintptr_t>> startPoolAllocatorSearch(const MemorySections& memorySections) {
        ...
        auto future_poolFuncDealloc = std::async([&]() {
            ...
            if (!result)  //vc143
                result = memorySections.findInMemoryPattern("", "xxxxx????xxxxxxxxxxxxxxxxxxx?xxxxxxxxxxxxxxxxx????x????xxxxxx????xxxxxxx?xxxxxx????xxxxxxxxxxxxxxxxxxxxxxxxxxxx?xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx");
