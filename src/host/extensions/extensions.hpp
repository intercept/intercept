...
#define EH(x) typedef void(__cdecl *##x##_func)
        ...
        EH(anim_changed)(object &unit_, std::string &anim_name_);
        EH(anim_done)(object &unit_, std::string &anim_name_);
        EH(anim_state_changed)(object &unit_, std::string &anim_name_);
        ...
        EH(dammaged)(object &unit_, std::string &selection_name_, float damage_);
        EH(engine)(object &vehicle_, bool engine_state_);
        EH(epe_contact)(object &object1_, object &object2_, std::string &selection1_, std::string &selection2_, float force_);
        EH(epe_contact_end)(object &object1_, object &object2_, std::string &selection1_, std::string &selection2_, float force_);
        EH(epe_contact_start)(object &object1_, object &object2_, std::string &selection1_, std::string &selection2_, float force_);
        EH(explosion)(object &vehicle_, float damage_);
        EH(fired)(object &unit_, std::string &weapon_, std::string &muzzle_, std::string &mode_, std::string &ammo_, std::string &magazine, object &projectile_);
        EH(fired_near)(object &unit_, object &firer_, float distance_, std::string &weapon_, std::string &muzzle_, std::string &mode_, std::string &ammo_);
        EH(fuel)(object &vehicle_, bool fuel_state_);
        EH(gear)(object &vehicle_, bool gear_state_);
        EH(get_in)(object &vehicle_, std::string position_, object &unit_, std::vector<int> &turret_path);
        EH(get_out)(object &vehicle_, std::string position_, object &unit_, std::vector<int> &turret_path);
        EH(handle_damage)(object &unit_, std::string &selection_name_, float damage_, object &source_, std::string &projectile_, int hit_part_index_);
        ...
        EH(incoming_missile)(object &unit_, std::string &ammo_, object &firer_);
        ...
        EH(post_reset)();
        EH(put)(object &unit_, object &container_, std::string item_);
        ...
        EH(take)(object &unit_, object &container_, std::string &item_);
